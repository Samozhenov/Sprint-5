...
func (w Walking) Calories() float64 {
	...
	KmInMsec := math.Pow(w.meanSpeed()*KmHInMsec, 2)
	return (CaloriesWeightMultiplier*w.Weight + (KmInMsec/(w.Height/CmInM))*CaloriesSpeedHeightMultiplier*w.Weight) * w.Duration.Hours() * MinInHours
}
